...
<div class="row">
    <div class="jumbotron bg-info text-white pt-3 pb-3">
        <h1 class="display3 text-center">Cserép módosítása</h1>
    </div>
</div>
<div class="container mt-5 d-flex justify-content-center">
    <div class="col-sm-6">
        <form action="index.php?controller=tile&action=update&tileID=<?php echo $tile->tileID;?>" method="POST">
            <div class="form-group">
                <label for="tileType">Cserép típusa*</label>
                <input type="text" class="form-control" name="tile[tileType]" id="tileType"
                value=<?php echo $tile->tileType; ?>
                required>
            </div>
            <div class="form-group">
                <label for="tileColor">Cserép színe*</label>
                <input type="text" class="form-control" name="tile[tileColor]" id="tileColor" 
                value=<?php echo $tile->tileColor; ?>
                required>
            </div>  
            <div class="form-group">
                <label for="tileManufacturer">Cserép gyártója*</label>
                <input type="text" class="form-control" name="tile[tileManufacturer]" id="tileManufacturer" 
                value=<?php echo $tile->tileManufacturer; ?>
                required>
            </div> 
