...
<div class="row">
    <div class="jumbotron bg-info text-white pt-3 pb-3">
        <h1 class="display3 text-center">Szerkezet módosítása</h1>
    </div>
</div>
<div class="container mt-5 d-flex justify-content-center">
    <div class="col-sm-6">
        <form action="index.php?controller=structure&action=update&structureID=<?php echo $structure->structureID;?>" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="structure[wood]" id="wood" value=<?php echo $structure->wood;?> required>
            </div>
            <div class="form-group">
                <label for="thickness">Vastagság*</label>
                <input type="text" class="form-control" name="structure[thickness]" id="thickness" value=<?php echo $structure->thickness;?> required>
            </div>  
            <div class="form-group">
                <label for="width">Szélesség*</label>
                <input type="text" class="form-control" name="structure[width]" id="width" value=<?php echo $structure->width;?>  required>
            </div>
            <div class="form-group">
                <label for="length">Hosszúság</label>
                <input type="text" class="form-control" name="structure[length]" id="length" value=<?php echo $structure->length;?> required>
            </div>
