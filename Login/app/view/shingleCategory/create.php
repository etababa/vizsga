...
<div class="row">
    <div class="jumbotron bg-info text-white pt-3 pb-3">
        <h1 class="display3 text-center">Új zsindely kategória felvitele</h1>
    </div>
</div>
    ...
    <div class="col-sm-6">
        <form action="" method="POST">
            <div class="form-group">
                <label for="shingleCategoryName">Zsindely kategória</label>
                <input type="text" class="form-control" name="shingleCategory[shingleCategoryName]" id="shingleCategoryName" required>
            </div>
