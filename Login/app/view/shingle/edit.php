...
<div class="row">
    <div class="jumbotron bg-info text-white pt-3 pb-3">
        <h1 class="display3 text-center">Zsindely módosítása</h1>
    </div>
</div>
<div class="container mt-5 d-flex justify-content-center">
    <div class="col-sm-6">
        <form action="index.php?controller=shingle&action=update&shingleID=<?php echo $shingle->shingleID;?>" method="POST">
            <div class="form-group">
                <label for="shingleType">Zsindely típusa*</label>
                <input type="text" class="form-control" name="shingle[shingleType]" id="shingleType" value=<?php echo $shingle->shingleType;?> required>
            </div>
            <div class="form-group">
                <label for="shingleColor">Zsindely színe*</label>
                <input type="text" class="form-control" name="shingle[shingleColor]" id="shingleColor" 
                value=<?php echo $shingle->shingleColor;?> required>
            </div>  
            <div class="form-group">
                <label for="shingleManufacturer">Zsindely gyártója*</label>
                <input type="text" class="form-control" name="shingle[shingleManufacturer]" id="shingleManufacturer"
                value=<?php echo $shingle->shingleManufacturer;?>  required>
            </div>
